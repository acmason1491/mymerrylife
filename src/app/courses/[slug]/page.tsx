...
const COURSES: Record<string, { title: string; description: string; category: string; catSlug: string; level: string; duration: number; price: number; lessons: { title: string; duration: number }[] }> = {
  ...
  "ecommerce-setup": {
    ...
    lessons: [{ title: "前置與準備事項", duration: 10 }, { title: "購買網站空間與網址申請", duration: 15 }, { title: "安裝 WordPress", duration: 10 }, { title: "Bluehost 控制面板設定", duration: 15 }, { title: "WordPress 控制面板設定", duration: 15 }, { title: "選擇外掛組合", duration: 10 }, { title: "外掛購買與安裝", duration: 10 }, { title: "主要頁面框架建立與編輯", duration: 20 }, { title: "網站主題與主要頁面優化", duration: 15 }, { title: "安裝 WooCommerce", duration: 10 }, { title: "WooCommerce 相關設定", duration: 20 }, { title: "Thrive Theme Builder 選擇模板", duration: 10 }, { title: "建立產品類別與發布產品", duration: 20 }, { title: "客製化購物網站模板", duration: 20 }, { title: "會員註冊功能", duration: 15 }, { title: "金流物流設定", duration: 20 }, { title: "購物下單測試", duration: 15 }, { title: "綠界科技註冊與設定", duration: 15 }],
  },
  "online-course-platform": {
    ...
    lessons: [{ title: "前置與準備事項", duration: 10 }, { title: "購買網站空間與網址申請", duration: 15 }, { title: "安裝 WordPress", duration: 10 }, { title: "Bluehost 控制面板設定", duration: 15 }, { title: "WordPress 控制面板設定", duration: 15 }, { title: "選擇外掛組合", duration: 10 }, { title: "外掛購買與安裝", duration: 10 }, { title: "主要頁面框架建立與編輯", duration: 20 }, { title: "網站主題與主要頁面優化", duration: 15 }, { title: "Thrive Apprentice 設定精靈", duration: 15 }, { title: "Thrive Apprentice 基本設定", duration: 15 }, { title: "建立第一個課程", duration: 20 }, { title: "自定義課程網頁模板", duration: 20 }, { title: "建立銷售課程", duration: 25 }, { title: "安裝 WooCommerce 外掛", duration: 10 }, { title: "在 WooCommerce 新增產品", duration: 15 }, { title: "Thrive Theme Builder 課程模板", duration: 15 }, { title: "客製化結帳頁模板", duration: 20 }, { title: "製作課程銷售頁面", duration: 25 }, { title: "WooCommerce 金流設定", duration: 20 }, { title: "購買訂單測試", duration: 15 }, { title: "綠界科技註冊與設定", duration: 15 }, { title: "會員管理頁面", duration: 15 }, { title: "Header 主選單編輯", duration: 10 }, { title: "主選單優化", duration: 10 }],
  },
